...
for n_training in range(1):

    if n_training == 0:
        data_dir = '/mnt/PALM_dataserv/DATA/JB/2021/Data_early_embryo_3D_DAPI/Data_in_shape'
        model_name = 'stardist_20210614_early_deconvolved'
    else:
    ...
    X = sorted(glob('train/deconvolved/*deconvolved*.tif'))
    ...
    X = sorted(glob('test/deconvolved/*deconvolved*.tif'))
    ...
    fig_name = data_dir + '/' + model_name + '/' + 'Statistics.png'
